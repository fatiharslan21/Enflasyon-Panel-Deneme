...
def dashboard_modu():
    ...
    if not df_f.empty and not df_s.empty:
        # Veri İşleme (HATA DÜZELTİLDİ: TİP DÖNÜŞÜMÜ)
        df_f['Kod'] = df_f['Kod'].astype(str).apply(kod_standartlastir)  # Kodu String'e Zorla
